...
def main():
    ...
    """
    with col1:
        st.markdown(f'<a href="https://github.com/yourusername" target="_blank" class="icon-button">{github_icon}</a>', unsafe_allow_html=True)
    ...
    """
    with col2:
        st.markdown(f'<a href="https://yourportfolio.com" target="_blank" class="icon-button">{portfolio_icon}</a>', unsafe_allow_html=True)
    ...
    """
    with col3:
        st.markdown(f'<a href="https://www.linkedin.com/in/yourprofile" target="_blank" class="icon-button">{linkedin_icon}</a>', unsafe_allow_html=True)
